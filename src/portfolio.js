...
const greeting = {
  ...
  logo_name: "Apex Developers",
  nickname: "Your vision,Our Expertise.Your Digital Destiny Begins Here.",
  subTitle:
    "At Apex Developers, we're a dynamic team of web development experts dedicated to crafting innovative digital solutions. With our passion for creativity and expertise in cutting-edge technologies, we specialize in delivering high-quality websites and applications tailored to meet your unique needs. Let us bring your vision to life and take your online presence to new heights.",
  resumeLink:
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Bespoke website development tailored to your unique requirements.",
        "⚡ Skilled team of developers dedicated to creating captivating online experiences.",
        "⚡ Results-driven approach focused on elevating your business's digital presenc",
      ],
      softwareSkills: [
        {
          skillName: "PHP",
    ...
    },
    {
      ...
      softwareSkills: [
        ...
        {
          skillName: "NodeJS",
          fontAwesomeClassname: "simple-icons:node-dot-jslogos:nodejs",
          style: {
            color: "#339933",
          },
        },
